...
low_freq_region_eq = np.where(hist_n_eq[0] < l_freq * np.max(hist_n_eq[0]))
...
hist_entropy_n_eq = compute_entropy(image_aerial[0], base=2)

# determinar a entropia do histograma da imagem equalizada
hist_entropy_eq = compute_entropy(image_eq[0], base=2)
